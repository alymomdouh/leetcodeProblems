<h2><a href="https://leetcode.com/problems/arithmetic-slices-ii-subsequence/solution/">446. Arithmetic Slices II - Subsequence</a></h2><h3>Hard</h3><hr><div><p>Given an integer array <code>nums</code>, return <em>the number of all the <strong>arithmetic subsequences</strong> of</em> <code>nums</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,4,6,8,10]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [7,7,7,7,7]
